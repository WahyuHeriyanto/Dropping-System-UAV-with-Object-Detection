...
def opencam():
    ...
    '''
    ap.add_argument('-ct', '--conf_threshold', default=1)
    ...
    for frame in camera.capture_continuous(rawCapture, format="bgr", use_video_port=True):
        ...
        if not outputQueue.empty():
            ...
            if nextwaypoint == 53:
                ...
                ser10 = 2006
                deteksi +=1
                print("Servo 10 Trigger")
                #plane.drop2()
                
            #Detection stopper Servo 9
            if nextwaypoint == 14:   
                confThreshold = 1
                
            #Detection stopper Servo 10
            if nextwaypoint == 55:   
                confThreshold = 1
        ...
        (170, 300), (0,0,0), -1)
        cv2.putText(frame,'Jumlah Deteksi: '+str(deteksi), (10, 280), cv2.FONT_HERSHEY_SIMPLEX, 0.3,(0, 255, 255), 1, cv2.LINE_AA)
