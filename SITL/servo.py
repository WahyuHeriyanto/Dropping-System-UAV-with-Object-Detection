...
#from refined_webcam_test_NCS2_mobilenet import *
...
class Plane():
    ...
    def drop1(self):
        ...
        msg = self.vehicle.message_factory.command_long_encode(0,0,mavutil.mavlink.MAV_CMD_DO_SET_SERVO, 0, 9, 2000, 0, 0, 0, 0, 0)
        self.vehicle.send_mavlink(msg)
        
    def drop2(self):
        
        msg = self.vehicle.message_factory.command_long_encode(0,0,mavutil.mavlink.MAV_CMD_DO_SET_SERVO, 0, 10, 2000, 0, 0, 0, 0, 0)
        self.vehicle.send_mavlink(msg)
    ...
    def fly_do_guided_request(self, target_system=1, target_component=1):
        ...
        self.master.mav.mission_item_int_send(
            ...
            0, # p3
            0, # p4
            int(-35.3566112 * 1e7), # latitude
            int(149.1790581 * 1e7), # longitude
            60,
            mavutil.mavlink.MAV_MISSION_TYPE_MISSION) # altitude
